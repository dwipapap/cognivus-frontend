      ...
      <div class="flex items-center justify-between px-6 lg:px-12 py-4">
        ...
        <div class="flex items-center gap-8">
          ...
          <NuxtLink to="/" class="flex items-center space-x-3">
            <img :src="ittrLogo" alt="ITTR" class="h-10 w-auto object-contain" />
          </NuxtLink>
        ...
        <div class="flex items-center gap-3">
          ...
          <!-- Login Button -->
          <NuxtLink to="/login"
            class="flex items-center gap-2 px-6 py-2.5 rounded-full bg-blue-600 text-white font-medium shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/40 transition-all duration-300 hover:scale-105 hover:bg-blue-700">>
            <span>Login</span>
