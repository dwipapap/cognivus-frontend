    ...
    <div v-else-if="myClasses.length > 0" class="space-y-6">
      ...
      <div class="bg-white rounded-2xl border border-gray-100 shadow-xl shadow-blue-900/5 p-6 mb-8">
        ...
        <div class="flex items-center gap-2 md:gap-4">
          ...
          >
            <UIcon name="i-basil-arrow-left-solid" class="w-4 h-4 md:w-5 md:h-5" />
          </button>
          ...
          >
            <UIcon name="i-basil-arrow-right-solid" class="w-4 h-4 md:w-5 md:h-5" />
          </button>
        </div>
      </div>
                        ...
                        <div class="space-y-2 max-h-48 overflow-y-auto pr-2">
                          ...
                          >
                            <div class="flex items-center gap-3 flex-1 min-w-0">
                              <UIcon name="i-solar-file-text-bold" class="w-5 h-5 text-blue-600 flex-shrink-0" />
                              <div class="flex-1 min-w-0">
                                <a 
                            ...
                            <button
                              ...
                              title="Delete File"
                            >
                              <UIcon name="i-solar-trash-bin-trash-bold" class="w-4 h-4" />
                            </button>
                          </div>
                        </div>
                      </div>
