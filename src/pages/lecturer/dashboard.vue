<script setup>
definePageMeta({ layout: 'lecturer', middleware: ['auth'], meta: { requiresAuth: true, role: 'dosen' } })
...
const goToMaterials = () => {
  navigateTo({ name: 'LecturerMaterials' });
};

/** Navigate to manage students page */
const goToManageStudents = () => {
  navigateTo({ name: 'LecturerStudents' });
};
...
const quickActions = computed(() => [
  {
    ...
    icon: 'grade',
    color: 'bg-blue-500',
    action: () => navigateTo({ name: 'LecturerStudents' })
  },
  {
    ...
    icon: 'upload',
    color: 'bg-blue-500',
    action: () => navigateTo({ name: 'LecturerMaterials' })
  }
]);
      ...
      <div
        ...
        <div class="flex items-start justify-between mb-6">
          ...
          <div class="w-12 h-12 bg-blue-500/10 rounded-2xl flex items-center justify-center">
            <UIcon name="i-solar-check-circle-bold" class="w-7 h-7 text-blue-600" />
          </div>
        </div>
        ...
        <div class="mt-6">
          <div class="flex items-center justify-between mb-4">
            <h3 class="text-base font-bold text-gray-900 flex items-center gap-2">
              <UIcon name="i-basil-clock-solid" class="w-4 h-4 text-blue-600" />
              Schedule
            </h3>
          ...
          <div v-if="myClasses.length === 0" class="text-center py-6 text-gray-500">
            <UIcon name="i-solar-calendar-bold" class="w-10 h-10 mx-auto mb-2 text-gray-300" />
            ...
            <div v-for="cls in myClasses.slice(0, 6)" :key="cls.classid"
              ...
              <div class="flex items-start gap-2">
                <div
                  ...
                  <UIcon name="i-basil-book-solid" class="w-4 h-4 text-white" />
                </div>
                <div class="flex-1 min-w-0">
                  ...
                  <div v-if="formatSchedule(cls)" class="flex items-center gap-1 mt-1">
                    <UIcon name="i-basil-clock-solid" class="w-3 h-3 text-blue-600 flex-shrink-0" />
        ...
        <div
          ...
          <div class="absolute top-4 right-4">
            <div class="w-10 h-10 bg-blue-500/10 rounded-xl flex items-center justify-center">
              <UIcon name="i-solar-users-group-rounded-bold" class="w-6 h-6 text-blue-600" />
            </div>
          </div>
          <div>
        ...
        <div
          ...
          <div class="absolute top-4 right-4">
            <div class="w-10 h-10 bg-indigo-500/10 rounded-xl flex items-center justify-center">
              <UIcon name="i-basil-book-solid" class="w-6 h-6 text-indigo-600" />
            </div>
          </div>
          <div>
            ...
            <button v-for="action in quickActions" :key="action.title" @click="action.action" class="group h-full">
              <div
                ...
                <div
                  ...
                  <UIcon name="i-solar-document-text-bold" v-if="action.icon === 'grade'" class="w-5 h-5 text-white" />
                  <UIcon name="i-solar-upload-bold" v-else-if="action.icon === 'upload'" class="w-5 h-5 text-white" />
                </div>
          ...
          <div class="flex items-center justify-between mb-3">
            <div class="flex items-center gap-2">
              <div class="w-7 h-7 bg-blue-500 rounded-lg flex items-center justify-center shadow-sm">
                <UIcon name="i-solar-calendar-bold" class="w-3.5 h-3.5 text-white" />
              </div>
              <div>
            ...
            <div class="flex items-center gap-1">
              <button @click="prevMonth"
                ...
                <UIcon name="i-solar-alt-arrow-left-linear" class="w-3 h-3 text-gray-600" />
              </button>
              <button @click="nextMonth"
                class="w-6 h-6 rounded-md bg-white hover:bg-blue-100 flex items-center justify-center transition-colors border border-gray-100">
                <UIcon name="i-solar-alt-arrow-right-linear" class="w-3 h-3 text-gray-600" />
              </button>
            </div>
          </div>
        ...
        <div
          ...
          <div class="flex items-center gap-2 mb-3 relative z-10">
            <div class="w-8 h-8 bg-white/20 rounded-lg flex items-center justify-center">
              <UIcon name="i-solar-lightbulb-bolt-bold" class="w-4 h-4 text-white" />
            </div>
