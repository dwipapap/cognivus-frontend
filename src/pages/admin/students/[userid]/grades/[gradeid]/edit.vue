<template>
  ...
  <button
    @click="goBack"
    class="mb-6 inline-flex items-center gap-2 px-4 py-2 text-blue-600 hover:text-white bg-blue-50 hover:bg-blue-600 rounded-full font-medium transition-all hover:shadow-md hover:scale-105 active:scale-95"
  >
  ...
  <div v-else-if="student && grade" class="space-y-8 mb-8">
    ...
    <div class="relative bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl shadow-lg overflow-hidden">
      ...
      <div class="relative p-5 md:p-8 z-10">
        <div class="mb-6">
          <h1 class="text-2xl md:text-3xl font-bold text-white mb-2">{{ isNewGrade ? 'Add New Grade' : 'Edit Grade' }}</h1>
      ...
      <div class="flex items-center gap-3 mb-6">
        ...
        <div class="flex flex-col sm:flex-row gap-3 mt-8 pt-6 border-t border-blue-200">
          <button
            ...
            class="flex-1 inline-flex items-center justify-center gap-2 px-6 py-3 bg-blue-600 text-white font-semibold rounded-full hover:bg-blue-700 hover:shadow-lg disabled:bg-gray-400 disabled:cursor-not-allowed transition-all shadow-md"
          >
            ...
            {{ isSubmitting ? (isNewGrade ? 'Adding Grade...' : 'Updating Grade...') : (isNewGrade ? 'Add Grade' : 'Update Grade') }}
          </button>
  ...
  await submit(async (data) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setTimeout(() => {
          navigateTo({ name: 'AdminStudentDetail', params: { id: userid } });
        }, 1000);
      } else {
