  ...
  <div>
    ...
    <div v-else class="grid grid-cols-2 md:grid-cols-4 gap-4">
      ...
      <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
        ...
        <NuxtLink to="/admin/students" class="mt-3 block text-xs text-blue-600 hover:text-blue-800 font-medium">
          Manage Students →
        </NuxtLink>
      </div>
      ...
      <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
        ...
        <NuxtLink to="/admin/lecturers" class="mt-3 block text-xs text-green-600 hover:text-green-800 font-medium">
          Manage Lecturers →
        </NuxtLink>
      </div>
      ...
      <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
        ...
        <NuxtLink to="/admin/classes" class="mt-3 block text-xs text-purple-600 hover:text-purple-800 font-medium">
          Manage Classes →
        </NuxtLink>
      </div>
