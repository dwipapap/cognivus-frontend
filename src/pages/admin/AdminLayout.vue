          ...
          <ul class="space-y-2">
            <li>
              <router-link to="/admin/dashboard"
                class="nav-item flex items-center px-3 py-2 text-sm font-medium text-gray-700 rounded-lg hover:text-blue-600">
            ...
            <li class="pt-4 mt-4 border-t border-white/20">
              <a @click="handleLogout"
                class="nav-item flex items-center px-3 py-2 text-sm font-medium text-gray-700 rounded-lg hover:text-red-600 cursor-pointer">
                <svg class="w-5 h-5 flex-shrink-0 mr-3" fill="currentColor" viewBox="0 0 20 20">
                  <path fill-rule="evenodd" d="M3 3a1 1 0 00-1 1v12a1 1 0 102 0V4a1 1 0 00-1-1zm10.293 9.293a1 1 0 001.414 1.414l3-3a1 1 0 000-1.414l-3-3a1 1 0 10-1.414 1.414L14.586 9H7a1 1 0 100 2h7.586l-1.293 1.293z" clip-rule="evenodd"></path>
                </svg>
                <span>Logout</span>
          ...
          <ul class="h-full flex justify-around items-center px-6">
            ...
            <li>
              <router-link to="/admin/lecturers" class="mobile-nav-item flex flex-col items-center gap-1">
                ...
                <span class="text-xs">Lecturers</span>
              </router-link>
            </li>
            <li>
