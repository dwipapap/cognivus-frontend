  ...
  <form @submit.prevent="handleSave" class="space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div class="space-y-6">
        ...
        <div class="bg-slate-50 rounded-lg p-4 border border-slate-200">
          ...
          <div class="space-y-4">
            ...
            />
            <p v-if="isEditMode" class="text-xs text-slate-500 -mt-2">Leave blank to keep existing username</p>
            ...
            />
            <p v-if="isEditMode" class="text-xs text-slate-500 -mt-2">Leave blank to keep existing email</p>
            ...
            />
            <p v-if="isEditMode" class="text-xs text-slate-500 -mt-2">Leave blank to keep existing password</p>
          </div>
        </div>
      ...
      <div class="space-y-6">
        ...
        <!-- Quick Info Card -->
        <div class="bg-slate-50 rounded-lg p-4 border border-slate-200">
          <h4 class="text-sm font-semibold text-slate-900 mb-3">Quick Guide</h4>
