        ...
        <div class="ml-auto flex items-center gap-1 xs:gap-2 sm:gap-3 md:gap-4 flex-nowrap min-w-0">
          ...
          <div class="relative z-50">
            ...
            <Teleport to="body">
              ...
              <!-- Dropdown Items -->
              <div class="py-1">
                <NuxtLink to="/lecturer/profile-view" class="profile-dropdown-item">
    ...
    <div class="flex flex-1 relative sidebar-container">
      ...
      <aside class="sidebar group w-19 hover:w-64 flex-shrink-0 sidebar-glass shadow-2xl transition-all duration-300 ease-in-out overflow-hidden fixed left-4 top-28 bottom-4 rounded-[28px] z-10 border border-white/20 hidden md:block">
        ...
        <nav class="p-4 h-full overflow-y-auto">
          ...
          <ul class="space-y-2">
            <li>
              <NuxtLink to="/lecturer/dashboard"
            ...
            <li>
              <NuxtLink to="/lecturer/materials"
                class="nav-item flex items-center px-3 py-2 text-sm font-medium rounded-lg group">
            ...
            <li>
              <NuxtLink to="/lecturer/students"
                class="nav-item flex items-center px-3 py-2 text-sm font-medium rounded-lg group">
                <UIcon name="i-solar-users-group-rounded-bold" class="w-5 h-5 flex-shrink-0" />
      ...
      <nav class="mobile-nav fixed bottom-0 left-0 right-0 h-16 bg-transparent md:hidden z-50">
        <div class="mobile-nav-glass h-full mb-0 rounded-3xl">
          <ul class="h-full flex justify-around items-center px-6">
            <li>
              <NuxtLink to="/lecturer/dashboard" class="mobile-nav-item flex flex-col items-center gap-1">
                <UIcon name="i-solar-home-smile-bold" class="w-5 h-5" />
                <span class="text-xs">Dashboard</span>
              </NuxtLink>
            </li>
            <li>
              <NuxtLink to="/lecturer/materials" class="mobile-nav-item flex flex-col items-center gap-1">
                <UIcon name="i-solar-book-bookmark-bold" class="w-5 h-5" />
                <span class="text-xs">Materials</span>
              </NuxtLink>
            </li>
            <li>
              <NuxtLink to="/lecturer/students" class="mobile-nav-item flex flex-col items-center gap-1">
                <UIcon name="i-solar-users-group-rounded-bold" class="w-5 h-5" />
